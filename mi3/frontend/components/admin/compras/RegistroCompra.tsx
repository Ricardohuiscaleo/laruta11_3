...
import type { CompraFormData, CompraFormItem, Kpi } from '@/types/compras';
  ...
  const handleSubmit = async () => {
    ...
    try {
      await comprasApi.post('/compras', {
        ...form,
        temp_image_keys: images.map(i => i.tempKey),
      });
      setSuccess(true);
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border bg-white p-4 shadow-sm">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">Tipo de compra</label>
      ...
      <div className="rounded-xl border bg-white p-4 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleSubmit} disabled={submitting || !form.proveedor || form.items.length === 0}
            className="rounded-lg bg-mi3-500 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-mi3-600 disabled:opacity-50">
