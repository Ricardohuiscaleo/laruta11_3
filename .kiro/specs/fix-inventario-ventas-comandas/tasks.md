...
- [x] 1.2 Deploy y verificar en SSH:
  ```
...
- [x] 2.5 Deploy y verificar en SSH:
  ```
...
- [x] 3.4 Deploy y verificar en SSH:
  ```
...
- [x] 4.4 Deploy y verificar en SSH:
  ```
...
- [x] 5.5 Deploy y verificar en SSH:
  ```
...
- [x] 6.2 Deploy y verificar en SSH:
  ```
...
- [x] 7.1 Ejecutar backfill script en producción vía SSH y capturar output
- [x] 7.2 Verificar en SSH:
  ```
...
- [x] 8.1 Test Webpay: crear orden, verificar sent_to_kitchen, comandas, inventario post-pago
- [x] 8.2 Test R11C: crear orden crédito, verificar inventario al crear, subtotal/delivery_fee correctos
- [x] 8.3 Test T11 regresión: verificar que register_success.php sigue funcionando
- [x] 8.4 Verificación final en SSH:
  ```
  mysql -e "
