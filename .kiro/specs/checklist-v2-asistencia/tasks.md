...
- [x] 1. Base de datos — Migraciones y seed
  - [x] 1.1 Crear migración ALTER TABLE `checklists` con columnas nuevas
  ...
  - [x] 1.2 Crear migración ALTER TABLE `checklist_items` con columnas de IA
    - Agregar columnas: ai_score (INT NULL), ai_observations (TEXT NULL), ai_analyzed_at (TIMESTAMP NULL)
    - _Requerimientos: 8.1, 3.3_
  - [x] 1.3 Crear migración ALTER TABLE `checklist_templates` para agregar columna `rol`
  ...
  - [x] 1.4 Crear migración para tabla nueva `checklist_virtual`
  ...
  - [x] 1.5 Crear seed para categoría "inasistencia" en `ajustes_categorias`
    - INSERT con nombre "Inasistencia", slug "inasistencia", ícono "❌", color "#ef4444", signo_defecto "-"
    - _Requerimiento: 8.4_
  - [x] 1.6 Eliminar GitHub Actions workflows (crons migrados a Coolify/Laravel)
...
- [x] 2. Modelos Eloquent
  - [x] 2.1 Crear modelo `Checklist` en `mi3/backend/app/Models/Checklist.php`
  ...
  - [x] 2.2 Crear modelo `ChecklistItem` en `mi3/backend/app/Models/ChecklistItem.php`
    - Definir $table = 'checklist_items', $fillable, $timestamps = false
    - Relación: checklist() belongsTo Checklist
    - _Requerimientos: 2.2, 3.3_
  - [x] 2.3 Crear modelo `ChecklistVirtual` en `mi3/backend/app/Models/ChecklistVirtual.php`
  ...
  - [x] 2.4 Crear modelo `ChecklistTemplate` en `mi3/backend/app/Models/ChecklistTemplate.php`
...
- [x] 3. ChecklistService — lógica central de checklists
  - [x] 3.1 Crear `mi3/backend/app/Services/Checklist/ChecklistService.php` con creación diaria desde templates BD
  ...
  - [x] 3.2 Implementar métodos de consulta y completado en ChecklistService
  ...
  - [x] 3.3 Implementar métodos de checklist virtual en ChecklistService
  ...
  - [x] 3.4 Implementar métodos admin en ChecklistService
  ...
  - [x] 3.5 Test de propiedad: creación de checklists corresponde a turnos asignados
  ...
  - [x] 3.6 Test de propiedad: creación idempotente de checklists
  ...
  - [x] 3.7 Test de propiedad: filtrado de checklists por rol del trabajador
  ...
  - [x] 3.8 Test de propiedad: progreso y completado de checklist
  ...
  - [x] 3.9 Test de propiedad: validación de foto obligatoria
  ...
  - [x] 3.10 Test de propiedad: validación de idea de mejora en checklist virtual
...
- [x] 4. AttendanceService — lógica de asistencia
  - [x] 4.1 Crear `mi3/backend/app/Services/Checklist/AttendanceService.php`
  ...
  - [x] 4.2 Implementar métodos de resumen en AttendanceService
  ...
  - [x] 4.3 Test de propiedad: determinación de asistencia por completado de checklist
  ...
  - [x] 4.4 Test de propiedad: detección de compañero ausente y habilitación de checklist virtual
  ...
  - [x] 4.5 Test de propiedad: correctitud del resumen mensual de asistencia
...
- [x] 5. PhotoAnalysisService — fotos y análisis IA
  - [x] 5.1 Crear `mi3/backend/app/Services/Checklist/PhotoAnalysisService.php`
  ...
  - [x] 5.2 Test de propiedad: selección de prompt IA según contexto
...
- [x] 6. Checkpoint — Backend servicios core
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Artisan Commands — Tareas programadas
  - [x] 7.1 Crear comando `mi3:create-daily-checklists`
  ...
  - [x] 7.2 Crear comando `mi3:detect-absences`
  ...
  - [x] 7.3 Crear comando `mi3:check-companion-absence`
...
- [x] 8. Controllers backend (Worker + Admin)
  - [x] 8.1 Crear `Worker/ChecklistController` con endpoints
  ...
  - [x] 8.2 Crear `Admin/ChecklistController` con endpoints
  ...
  - [x] 8.3 Registrar nuevas rutas en `mi3/backend/routes/api.php`
  ...
  - [x] 8.4 Test de propiedad: filtrado por fecha retorna solo checklists correspondientes
  ...
  - [x] 8.5 Test de propiedad: ideas de mejora ordenadas por fecha descendente
...
- [x] 9. Checkpoint — Backend completo
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Frontend — Tipos e interfaces TypeScript
  - [x] 10.1 Agregar tipos en `mi3/frontend/types/index.ts`
...
- [x] 11. Frontend — Página de Checklist del Trabajador
  - [x] 11.1 Crear `mi3/frontend/app/dashboard/checklist/page.tsx`
  ...
  - [x] 11.2 Implementar sección de checklist virtual en la misma página
...
- [x] 12. Frontend — Panel Admin de Checklists
  - [x] 12.1 Crear `mi3/frontend/app/admin/checklists/page.tsx`
    ...
    - _Requerimientos: 7.1, 7.2, 7.3, 7.4, 7.5_
  - [x] 12.2 Crear vista de detalle de checklist en admin
...
- [x] 13. Frontend — Navegación actualizada
  - [x] 13.1 Actualizar `mi3/frontend/lib/navigation.ts`
    ...
    - _Requerimientos: 9.1, 9.3_
  - [x] 13.2 Implementar badge de checklists pendientes en navegación
