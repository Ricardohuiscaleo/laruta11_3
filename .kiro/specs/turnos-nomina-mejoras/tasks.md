...
- [ ] 1.1 Agregar `total_reemplazando` y `total_reemplazados` al array de retorno de `LiquidacionService::calcular()`
...
- [ ] 2.1 Extend `PayrollController::index()` to include replacement breakdown fields in `$workersMap`
...
- [ ] 3.1 Add R11 credit pending calculation to `PayrollController::index()`
  - File: `mi3/backend/app/Http/Controllers/Admin/PayrollController.php`
...
- [ ] 4.1 Update `WorkerPayroll` interface and add `ReplacementGroup` interface
...
- [ ] 4.2 Add compact replacement display to worker cards
  - File: `mi3/frontend/components/admin/sections/NominaSection.tsx`
...
- [ ] 4.3 Add expandable card with full breakdown
  - File: `mi3/frontend/components/admin/sections/NominaSection.tsx`
...
- [ ] 4.4 Add R11 credit pending indicator below gran_total
  - File: `mi3/frontend/components/admin/sections/NominaSection.tsx`
...
- [ ] 5.1 Reduce calendar cell size and add mini avatars in desktop view
...
- [ ] 5.2 Add replacement indicator to calendar cells
  - File: `mi3/frontend/components/admin/sections/TurnosSection.tsx`
...
- [ ] 5.3 Add replacement indicator to mobile day cards
  - File: `mi3/frontend/components/admin/sections/TurnosSection.tsx`
...
- [ ] 5.4 Improve replacement display in day detail panel
  - File: `mi3/frontend/components/admin/sections/TurnosSection.tsx`
