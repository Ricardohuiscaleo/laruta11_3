...
| mi3-backend | api-mi3.laruta11.cl | Laravel 11 + PHP 8.3 + Reverb | ✅ Running (`d162556`) — prompt Unimarc RUT fix + packaging equivalencias + knownPatterns |
...
**Commits:** `5b8ed85`, `b860495`, `f3816c3`, `1fa5f65`, `ce3a50a`, `3419f96`, `2e85939`, `d162556`
**Deploys:** mi3-frontend ✅ (`2e85939`), mi3-backend ✅ (`d162556`)
