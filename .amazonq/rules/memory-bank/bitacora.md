...
| mi3-frontend | mi.laruta11.cl | Next.js 14 + React + Echo | ✅ Running (`3c85282`) — delivery map con logo La Ruta 11 |
| mi3-backend | api-mi3.laruta11.cl | Laravel 11 + PHP 8.3 + Reverb | ✅ Running (`f399034`) — delivery:simulate via popen() |
