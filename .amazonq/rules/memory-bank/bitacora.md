...
| mi3-frontend | mi.laruta11.cl | Next.js 14 + React + Echo | ✅ Running (`77d6137`) — CMV chevron: columnas alineadas + combos |
| mi3-backend | api-mi3.laruta11.cl | Laravel 11 + PHP 8.3 + Reverb | ✅ Running (`77d6137`) — CMV desglose combos reescrito + g→kg |
