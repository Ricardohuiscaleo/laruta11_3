...
try {
    ...
    // Columna para rastrear cashback generado por nivel (usando método compatible)
    $cols = [
        'cashback_level_bronze' => 'TINYINT(1) DEFAULT 0',
        'cashback_level_silver' => 'TINYINT(1) DEFAULT 0',
        'cashback_level_gold' => 'TINYINT(1) DEFAULT 0'
    ];
