...
switch ($action) {
    ...
    case 'save_turno': {
        ...
        if (!$personal_id || !$fecha) { echo json_encode(['success'=>false,'error'=>'Datos incompletos']); exit; }
    ...
    case 'save_presupuesto': {
        ...
        if (!$mes || !$monto) { echo json_encode(['success'=>false,'error'=>'Datos incompletos']); exit; }
