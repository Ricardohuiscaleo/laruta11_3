...
VALUES ('combos', 'Combos', 'combo', '#FF6B35', 1, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (1, 'Combos', 1, 1, 8);

-- Sandwiches
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('churrascos', 'Sandwiches', 'sandwich', '#FF6347', 2, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (2, 'Carne', 1, 1, 2);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (2, 'Pollo', 2, 1, 2);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (2, 'Vegetariano', 3, 1, 2);

-- Hamburguesas 200g
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('hamburguesas', 'Hamburguesas\n(200g)', 'hamburger', '#D2691E', 3, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_id) 
VALUES (3, 'Clásicas', 1, 1, 3, 6);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_id) 
VALUES (3, 'Especiales', 2, 1, 3, 6);

-- Hamburguesas 100g
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('hamburguesas_100g', 'Hamburguesas\n(100g)', 'hamburger_small', '#D2691E', 4, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_id) 
VALUES (4, 'Clásicas', 1, 1, 3, 5);

-- Completos
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('completos', 'Completos', 'hotdog', '#FF4500', 5, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (5, 'Tradicionales', 1, 1, 4);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id) 
VALUES (5, 'Al Vapor', 2, 1, 4);

-- Papas
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('papas', 'Papas', 'fries', '#FFD700', 6, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_ids) 
VALUES (6, 'Papas Fritas', 1, 1, 12, '[9,57]');

-- Pizzas
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('pizzas', 'Pizzas', 'pizza', '#FF6347', 7, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_id) 
VALUES (7, 'Pizzas', 1, 1, 5, 60);

-- Bebidas
INSERT INTO menu_categories (slug, display_name, icon_type, color, sort_order, is_active) 
VALUES ('bebidas', 'Bebidas', 'drink', '#4299E1', 8, 1);

INSERT INTO menu_subcategories (menu_category_id, display_name, sort_order, is_active, category_id, subcategory_ids) 
VALUES (8, 'Bebidas', 1, 1, 5, '[11,10,28,27]');
