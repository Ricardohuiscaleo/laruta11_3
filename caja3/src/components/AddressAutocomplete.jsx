...
const AddressAutocomplete = ({ value, onChange, placeholder = "Escribe tu dirección...", className = "", onDeliveryFee = null, addressValidated = false, hasError = false }) => {
    ...
    <div ref={wrapperRef}>
      <div style={{ position: 'relative' }} ref={inputRef}>
        <input
          ...
          onBlur={handleBlur}
          className={className || `w-full px-3 py-2 pl-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 ${hasError ? 'border-red-500 bg-red-50 animate-shake' : 'border-gray-300'}`}
